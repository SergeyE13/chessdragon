...
app.use((req, res, next) => {
    ...
    // Получаем sessionId из cookie или создаём новый
    ...
    if (!sessionId || !activeSessions.has(sessionId)) {		
        ...
        // Сохраняем sessionId в cookie на 24 часа
        ...
        console.log(`♻️ Existing session: ${sessionId} from ${ip}`);
    }
    ...
    console.log(`📊 ${method} ${url} | Session: ${sessionId} | Requests: ${session.requestCount}`);
